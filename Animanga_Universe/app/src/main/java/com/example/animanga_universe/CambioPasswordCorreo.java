 ...
 */
public class CambioPasswordCorreo extends AppCompatActivity implements View.OnClickListener {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        for(DataSnapshot d: snapshot.getChildren()){
                            ...
                            if(contador>0){
                                ...
                                MailAPI api= new MailAPI(CambioPasswordCorreo.this,mail,subject,codigo);
                                api.execute();
                                Intent intent = new Intent(CambioPasswordCorreo.this, CodigoVerificacion.class);
